                ...
                <table style={styles.errorTable}>
                  <thead>
                    <tr style={styles.errorTableHeaderRow}>
                      ...
                      <th style={styles.errorTableHeader}>日付</th>
                  ...
                  <tbody>
                    {result.errors.map((error, index) => (
                      <tr key={index} style={styles.errorTableRow}>
                        ...
                        <td style={styles.errorTableCell}>{error.date}</td>
...
const SummaryItem: React.FC<SummaryItemProps> = ({ label, value, color, icon }) => {
  return (
    <div style={styles.summaryItem}>
      <span style={styles.summaryIcon}>{icon}</span>
      <div style={styles.summaryContent}>
        <div style={styles.summaryLabel}>{label}</div>
        <div style={{ ...styles.summaryValue, color }}>{value.toLocaleString()}</div>
      </div>
    </div>
  );
};
